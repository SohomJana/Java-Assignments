...
public class Functions extends Database{ public Functions() throws SQLException {
}
    ...
    void add(int id, String name, double marks) throws SQLException {
        ...
        stmt.setInt(1, id); stmt.setString(2, name); stmt.setDouble(3, marks); stmt.executeUpdate();
    }
    ...
    void show() throws SQLException {
        ...
        {
            System.out.println("ID : "+rs.getInt("id")); System.out.println("Name : "+rs.getString("name")); System.out.println("Marks : "+rs.getDouble("marks"));
        }
    }
